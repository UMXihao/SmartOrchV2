...
def recommend(policy_path: str, target_ratio: float):
    ...
    cmd = [
        "/home/lili-5090/Sean/SmartOrchV2/build/bin/llama-cli",
        "-m", "/home/lili-5090/Sean/llama.cpp/models/deepseek-v2-lite-chat-q4_0.gguf",
        "--attn-heads", str(heads),
        "--override-kv", f"deepseek2.expert_used_count=int:{experts}",
    ]
